                ...
                <div className="privacy-policy-content">
                    ...
                    <div className="policy-section">
                        ...
                        <ul className="policy-contact-info">
                            <li><strong>ایمیل پشتیبانی:</strong> support@bookkadeh.com</li>
                            <li><strong>تلفن پاسخگویی:</strong> ۰۲۱-۷۷۴۵۰۰۰۰</li>
                            <li><strong>نشانی:</strong> تهران، دانشگاه علم و صنعت ایران، مرکز نوآوری بوک‌کده</li>
                        </ul>
                    </div>

                    {/* Footer */}
                    <div className="policy-footer">
                        <p>استفاده از سامانه کتابخوانی بوک‌کده به معنای پذیرش کامل این منشور اخلاقی و حریم خصوصی است.</p>
                    </div>
                </div>
            </div>
        );
