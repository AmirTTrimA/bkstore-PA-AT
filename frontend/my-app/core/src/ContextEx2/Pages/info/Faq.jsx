...
const FAQ_DATA_FA = [
    ...
    },
    {
        ...
        answer: "بله! کتاب‌خوان هوشمند بوک‌کده آخرین صفحه مطالعه‌شده و یادداشت‌های شما را در سرور ذخیره و همگام می‌کند.",
        category: 'Reading'
    },
    {
        question: "آیا پیشرفت مطالعه من در دستگاه‌های مختلف همگام می‌شود؟",
        answer: "بله! کتاب‌خوان هوشمند بوک‌کده آخرین صفحه مطالعه‌شده و یادداشت‌های شما را در سرور ذخیره و همگام می‌کند.",
        category: 'Features'
    },
    {
    ...
    },
    {
        ...
        answer: "بله! با اشتراک باشگاه کتاب بوک‌کده دسترسی نامحدود به کاتالوگ عظیم کتاب‌های الکترونیکی و صوتی خواهید داشت.",
        category: 'Purchasing'
    },
    {
        question: "چگونه با پشتیبانی سامانه تماس بگیرم؟",
        answer: "شما می‌توانید به نشانی support@bookkadeh.com ایمیل بزنید یا از بخش تیکت پشتیبانی داشبورد پیام دهید.",
        category: 'Account'
    }
];
