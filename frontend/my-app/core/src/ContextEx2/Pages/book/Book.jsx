...
import { pic1, pic2, pic3, pic4, pic5, ppic1 } from '../../Constants';
...
export default function Book() {
    ...
    const loadBook = async () => {
      try {
        ...
        setBook({
          ...
          name: data.title,
          format: "physical",
          pd_price: data.price ? `$${data.price}` : "N/A",
          ph_price: data.price ? `$${data.price}` : "N/A",
          category: ["general"],
          comments: [],
          imageUrl:
        ...
        setFormat("physical");
        setPrice(data.price ? `$${data.price}` : "N/A");
      } catch (err) {
  ...
  if (loading) {
    return <div className="container py-5 text-center">Loading book...</div>;
  }

  if (!book) {
    return <div className="container py-5 text-center">Book not found.</div>;
  }
